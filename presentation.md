# Presentation: The Emergence of Event Structure in Pre-Linguistic Infants

## Slide 1: Definitions & Gaze Strategies
...
**Key Finding:** There is a significant linear increase in this strategy from 7 to 11 months.
...
## Slide 5: The Semantic Control (GW vs. UGW)

**The Question:** Are 10-month-olds looking at faces because they understand the meaning, or just because faces are attractive?
...
## Slide 6: The "Anticipation Gap" (Latency to Toy)

**The Concept:** Theory of Mind allows us to predict the transfer before it happens.

**The Finding:** Adults anticipate instantly. Infants—even the oldest ones—are significantly slower.

**Stats:**
*   Adults: 4.0 frames (Immediate/Predictive).
*   Infants (All Ages): 13–22 frames (Reactive).
*   Significance: Every infant cohort is significantly slower than adults (p < 0.01).

**Conclusion:** While 11-month-olds understand the structure (they look at faces), they have not mastered the efficiency (they are still processing, not predicting).

**Visual:** [Insert: The Bar Chart of Mean Latency (Adults vs. Infants) with significance stars - `gw_latency_to_toy_min3_50_percent_latency_to_toy_bar.png`]

---

## Slide 7: The "Reaction Check" (Show Condition)

**The Concept:** In a "Show" event, the goal is the other person's reaction. Do infants check the Man's face?

**The Finding:** A massive deficit.

**Stats:**
*   Adults: Check the Man 52% of the time.
*   7-Month-Olds: Check 0% of the time.
*   11-Month-Olds: Check only 9% of the time.
*   All infant groups are significantly lower than adults (p < 0.001).

**Conclusion:** Pre-linguistic event representation is "Partial." They get the Agent (Woman) and the Object (Toy), but they miss the Social Goal (The Man's Reaction).

**Visual:** [Insert: The Bar Chart for "Looking at Man during Reaction Window" - `sw_time_window_min3_50_percent_time_window_bar_plot.png`]
