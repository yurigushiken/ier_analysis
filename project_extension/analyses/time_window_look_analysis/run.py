...
if __package__ in (None, ""):
    ...
    from project_extension.analyses.time_window_look_analysis import calculator, stats, visuals
else:
...
def run_analysis(config_path: Path) -> None:
    ...
    bar_title = (
        f'"{condition_label}" – Probability of fixation on {config["target_aoi"]}\n'
