...
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/gw_min4.yaml
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/gwo_min4.yaml
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/gw_min4_35-90.yaml
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/gwo_min4_35-90.yaml
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/gw_min3.yaml
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/gwo_min3.yaml
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/sw_min3.yaml
python project_extension/analyses/tri_argument_fixation/run.py --config project_extension/analyses/tri_argument_fixation/swo_min3.yaml
```
